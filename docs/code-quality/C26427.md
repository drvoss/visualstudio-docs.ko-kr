...
전역 개체는 일관성이 없거나 정의 되지 않은 순서로 초기화 될 수 있습니다. 즉,이는 두 개체 간의 상호 종속성이 위험 하므로 피해 야 합니다. 이 지침은 이니셜라이저가 @no__t 된 것으로 간주 되는 다른 개체를 참조 하는 경우에 적용할 수 있습니다.

## <a name="remarks"></a>설명

개체는 다음 규칙을 준수 하는 경우 0 @no__t 간주 됩니다.
