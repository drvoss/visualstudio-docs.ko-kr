...
ms.locfileid: "72013243"
---
# <a name="c6282"></a>C6282
경고 C6282: 잘못 된 연산자: 부울 컨텍스트에서 상수를 할당 했습니다. 대신 ' = = '를 사용 하십시오.

 이 경고는 테스트 컨텍스트에서 변수에 대 한 상수 할당이 검색 되었음을 나타냅니다. 테스트 컨텍스트의 변수에 상수를 할당 하는 것은 거의 항상 올바르지 않습니다. @No__t-0을 `==`로 바꾸거나 테스트 컨텍스트에서 할당을 제거 하 여이 경고를 해결 합니다.
