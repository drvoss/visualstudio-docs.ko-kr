...
ms.locfileid: "72017321"
---
# <a name="c6400"></a>C6400
경고 C6400: @No__t-0function name >를 사용 하 여 대/소문자를 구분 하지 않는 비교를 상수 문자열 \<string name >로 수행 합니다. 영어가 아닌 로캘에서는 예기치 않은 결과를 생성 합니다.
 ...
 일반적으로 `CompareString` 함수를 사용 하 여 문자열 비교를 수행 해야 합니다. Windows XP에서 로캘 독립적 비교를 수행 하려면 첫 번째 매개 변수가-0 @no__t 상수 여야 합니다.
