...
@No__t 적용 되지 않은 열거형은 0 값을 가진 멤버를 정의 하지 않습니다. 또는 @no__t 적용 된 열거형의 값이 0이 고 해당 이름이 ' n o n e '이 아닌 멤버를 정의 합니다. 또는 열거형은 0이 아닌 여러 개의 멤버를 정의 합니다.
