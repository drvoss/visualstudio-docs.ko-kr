...
메서드에 이름이 `Get`시작 하 고 매개 변수를 사용 하지 않으며 배열이 아닌 값을 반환 합니다.
...
<xref:System.Diagnostics.DebuggerBrowsableAttribute?displayProperty=fullName>를 적용 하 여 디버거가 자동 확장 속성을 방지할 수 있습니다. 다음 예에서는이 특성을 instance 속성에 적용 하는 방법을 보여 줍니다.
