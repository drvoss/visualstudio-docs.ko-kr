...
@No__t_0 클래스에서 파생 된 특성의 속성에 대해 발생 하는 경고를 표시 하지 않을 수 있습니다. 특성에는 배열을 반환 하는 속성이 포함 될 수 있지만 컬렉션을 반환 하는 속성은 포함할 수 없습니다.
...
다음 예제에서는 <xref:System.Collections.ObjectModel.ReadOnlyCollection%601?displayProperty=fullName> 반환 하도록 속성을 변경 하 여 위반을 수정 합니다.
...
다음 예제에서는 <xref:System.Collections.ObjectModel.Collection%601?displayProperty=fullName> 반환 하도록 속성을 변경 하 여 위반을 수정 합니다.
