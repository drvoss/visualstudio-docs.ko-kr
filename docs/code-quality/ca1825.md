...
요소가 없는 빈 <xref:System.Array>이 할당 됩니다.
...
> [!TIP]
> Visual Studio에서이 규칙에 대 한 코드 수정을 사용할 수 있습니다. 이를 사용 하려면 배열 할당에 커서를 놓고 **ctrl**+을 누릅니다 **.** 누릅니다. 표시 되는 옵션 목록에서 **배열형 사용** 을 선택 합니다.
>
...
- [CA1814: 다차원 @ no__t에서 가변 배열을 사용 하는 것이 좋습니다.-0
