...
- [정수 형식](/dotnet/csharp/language-reference/keywords/integral-types-table), [부동 소수점 형식](/dotnet/csharp/language-reference/keywords/floating-point-types-table)및 <xref:System.Boolean>을 포함 하는 값 형식의 배열입니다.
