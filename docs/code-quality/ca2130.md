...
## <a name="cause"></a>원인
상수 필드 또는 열거형 멤버는 <xref:System.Security.SecurityCriticalAttribute>으로 표시 됩니다.
...
## <a name="example"></a>예제
다음 예제에서 열거형 값은-0 @no__t 하 고 상수 `CriticalConstant`은이 경고를 발생 시킵니다. 문제를 해결 하려면 [`SecurityCritical`] 특성을 제거 하 여 보안을 투명 하 게 만듭니다.
