...
## <a name="example"></a>예제
다음 예제에서 메서드는 <xref:System.Security.SecuritySafeCriticalAttribute> 특성으로 표시 되 고 <xref:System.Security.SecurityCriticalAttribute> 특성으로 표시 된 클래스의 멤버입니다. 보안 안전 특성을 제거 해야 합니다.
