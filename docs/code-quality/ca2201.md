...
|0 @no__t 값이 잘못 되었습니다.|<xref:System.ComponentModel.InvalidEnumArgumentException?displayProperty=fullName>|
...
작업이 개체의 현재 상태에 대해 유효 하지 않은 경우 @no__t가 throw 됩니다.
