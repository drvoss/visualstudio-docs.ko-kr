...
열거형이 <xref:System.FlagsAttribute>으로 표시 되어 있고 두 값이 둘 이상 이거나 열거형에 정의 된 다른 값의 조합이 아닙니다.

기본적으로이 규칙은 외부에서 볼 수 있는 열거만 보이지만 [구성 가능](#configurability)합니다.

## <a name="rule-description"></a>규칙 설명

열거형에 정의 된 각 값이 2의 거듭제곱 또는 정의 된 값의 조합 인 경우에만 열거형에 @no__t 0이 있어야 합니다.
...
다음 코드에서는 값 3을 포함 하는 열거형 (`Color`)을 보여 줍니다. 3은 2의 거듭제곱이 아니거나 정의 된 값의 조합입니다. @No__t-0 열거형은 <xref:System.FlagsAttribute>로 표시 되어서는 안 됩니다.

[!code-cpp[FxCop.Usage.EnumNoFlags#1](../code-quality/codesnippet/CPP/ca2217-do-not-mark-enums-with-flagsattribute_1.cpp)]
[!code-csharp[FxCop.Usage.EnumNoFlags#1](../code-quality/codesnippet/CSharp/ca2217-do-not-mark-enums-with-flagsattribute_1.cs)]
[!code-vb[FxCop.Usage.EnumNoFlags#1](../code-quality/codesnippet/VisualBasic/ca2217-do-not-mark-enums-with-flagsattribute_1.vb)]

다음 코드에서는 <xref:System.FlagsAttribute>로 표시 되는 요구 사항을 충족 하는 열거형 `Days`을 보여 줍니다.
