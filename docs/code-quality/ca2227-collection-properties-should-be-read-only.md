...
이진 및 XML serialization은 모두 컬렉션인 읽기 전용 속성을 지원 합니다. @No__t-0 클래스에는 <xref:System.Collections.ICollection>과 <xref:System.Collections.IEnumerable?displayProperty=fullName>를 구현 하는 형식에 대 한 특정 요구 사항이 있으므로 serialize 할 수 있습니다.
...
- [CA1819: 속성은 @ no__t-0 배열을 반환 해서는 안 됩니다.