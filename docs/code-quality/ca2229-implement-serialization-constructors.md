...
- 형식에 <xref:System.Runtime.Serialization.SerializationInfo> 개체 <xref:System.Runtime.Serialization.StreamingContext> 와 개체 (serialization 생성자의 시그니처)를 사용 하는 생성자가 없습니다.
