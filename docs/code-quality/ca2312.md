...
@No__t-0 deserialization 메서드가 호출 되었거나 참조 되었으며 <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> 속성은 null 일 수 있습니다.

## <a name="rule-description"></a>규칙 설명

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

이 규칙은 <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder>이 null 일 수 있는 경우 0 @no__t deserialization 메서드 호출 또는 참조를 찾습니다. @No__t-1 속성에 관계 없이 <xref:System.Runtime.Serialization.NetDataContractSerializer>으로 deserialization을 허용 하지 않으려면이 규칙 및 [CA2311](ca2311.md)를 사용 하지 않도록 설정 하 고 rule [CA2310](ca2310.md)을 사용 하도록 설정 합니다.
...
[CA2310: 안전 하지 않은 역직렬 변환기 NetDataContractSerializer @ no__t 사용 안 함-0

[CA2311: 먼저 NetDataContractSerializer @ no__t를 설정 하지 않고 deserialize 합니다.
