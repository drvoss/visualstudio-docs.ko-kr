---
title: 'CA2322: deserialize 하기 전에 SimpleTypeResolver를 사용 하 여 JavaScriptSerializer를 초기화 하지 않았는지 확인 합니다.'
ms.date: 05/08/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809441"
---
# <a name="ca2322-ensure-javascriptserializer-is-not-initialized-with-simpletyperesolver-before-deserializing"></a>CA2322: deserialize 하기 전에 SimpleTypeResolver를 사용 하 여 JavaScriptSerializer를 초기화 하지 않았는지 확인 합니다.
...
<xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> deserialization 메서드가 호출 되었거나 참조 되었으며 <xref:System.Web.Script.Serialization.JavaScriptSerializer> <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>를 사용 하 여 초기화 되었을 수 있습니다.
...
이 규칙은 <xref:System.Web.Script.Serialization.JavaScriptSerializer> <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>를 사용 하 여 초기화 되었을 수 있는 경우 <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> deserialization 메서드 호출 또는 참조를 찾습니다.

## <a name="how-to-fix-violations"></a>위반 문제를 해결하는 방법

- <xref:System.Web.Script.Serialization.JavaScriptTypeResolver?displayPropertyName=nameWithType> 개체가 <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>를 사용 하 여 초기화 되지 않았는지 확인 합니다.
