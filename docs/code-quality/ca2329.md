---
title: 'CA2329: 안전 하지 않은 구성을 사용 하 여 JsonSerializer로 deserialize 하지 마십시오.'
...
ms.locfileid: "73441267"
---
# <a name="ca2329-do-not-deserialize-with-jsonserializer-using-an-insecure-configuration"></a>CA2329: 안전 하지 않은 구성을 사용 하 여 JsonSerializer로 deserialize 하지 마십시오.
