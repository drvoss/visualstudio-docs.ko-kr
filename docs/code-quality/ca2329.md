---
title: 'CA2329: 안전하지 않은 구성을 사용하여 JsonSerializer로 deserialize하지 마세요.'
...
ms.locfileid: "69893849"
---
# <a name="ca2329-do-not-deserialize-with-jsonserializer-using-an-insecure-configuration"></a>CA2329: 안전하지 않은 구성을 사용하여 JsonSerializer로 deserialize하지 마세요.
