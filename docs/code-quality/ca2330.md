---
title: 'CA2330: deserialize할 때 JsonSerializer에 보안 구성이 있는지 확인하세요.'
...
ms.locfileid: "71237440"
---
# <a name="ca2330-ensure-that-jsonserializer-has-a-secure-configuration-when-deserializing"></a>CA2330: deserialize할 때 JsonSerializer에 보안 구성이 있는지 확인하세요.
...
- [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializer_TypeNameHandling.htm) 속성은 이외의 `None`값입니다.
...
- [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm) 속성이이 아닌 `None`값인 경우 [newtonsoft.json](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializer_SerializationBinder.htm) 속성은 항상 설정 되어 있습니다.
