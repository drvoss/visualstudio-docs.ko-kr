---
title: 'CA5364: 사용 되지 않는 보안 프로토콜을 사용 하지 마십시오.'
...
ms.locfileid: "71933158"
---
# <a name="ca5364-do-not-use-deprecated-security-protocols"></a>CA5364: 사용 되지 않는 보안 프로토콜을 사용 하지 마십시오.
