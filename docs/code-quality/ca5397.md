---
title: 'CA5397: 사용 되지 않는 SslProtocols 값을 사용 하지 마십시오.'
...
ms.locfileid: "75718612"
---
# <a name="ca5397-do-not-use-deprecated-sslprotocols-values"></a>CA5397: 사용 되지 않는 SslProtocols 값을 사용 하지 마십시오.
...
- 사용 되지 않는 값을 나타내는 정수 값이 <xref:System.Security.Authentication.SslProtocols> 변수에 할당 되었거나 <xref:System.Security.Authentication.SslProtocols> 반환 값으로 사용 되거나 <xref:System.Security.Authentication.SslProtocols> 인수로 사용 되었습니다.
...
[CA5364: 사용 되지 않는 보안 프로토콜을 사용 하지 마십시오.](ca5364.md)

[CA5386: 하드 코딩 SecurityProtocolType 값을 사용 하지 마십시오.](ca5386.md)

[CA5398: 하드 코드 SslProtocols 값을 사용 하지 않습니다.](ca5398.md)
