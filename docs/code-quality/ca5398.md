---
title: 'CA5398: 하드 코드 SslProtocols 값을 사용 하지 않습니다.'
...
ms.locfileid: "75718625"
---
# <a name="ca5398-avoid-hardcoded-sslprotocols-values"></a>CA5398: 하드 코드 SslProtocols 값을 사용 하지 않습니다.
...
- 안전 하지만 하드 코드 된 <xref:System.Security.Authentication.SslProtocols?displayProperty=nameWithType> 값이 참조 되었습니다.
...
[CA5397: 사용 되지 않는 SslProtocols 값을 사용 하지 마십시오.](ca5397.md)
