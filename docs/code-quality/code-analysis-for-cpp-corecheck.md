...
[C26448 USE_GSL_FINALLY](c26448.md) 최종 동작을 의도 한 경우 `gsl::finally`를 사용 하는 것이 좋습니다. 참조 [c + + Core Guidelines: GSL.util: 유틸리티](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities)합니다.
