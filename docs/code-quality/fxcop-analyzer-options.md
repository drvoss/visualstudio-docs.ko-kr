...
| 설명 | 허용 가능한 값 | 기본값 | 구성 가능한 규칙 |
| - | - | - | - |
| 규칙에서 단일 문자 [형식 매개 변수](/dotnet/csharp/programming-guide/generics/generic-type-parameters) 를 제외할지 여부 (예: `Collection<S>`의 `S`) | `true`<br/>`false` | `false` | [CA1715](ca1715.md) |
