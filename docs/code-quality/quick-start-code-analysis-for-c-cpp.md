...
3. 선택한 구성을 사용 하 여 프로젝트를 빌드할 때마다 코드 분석을 실행 하려면 선택 합니다 **빌드에 코드 분석 사용** 확인란 합니다. **분석** 메뉴를 열고 *ProjectName* **에 대해 코드 분석 실행** 또는 **파일에서 코드 분석**실행을 선택 하 여 코드 분석을 수동으로 실행할 수도 있습니다.
...
3. **메시지 표시 안 함** 을 선택한 다음 **원본에서를**선택 합니다.
   ...
   코드 줄에 대 한 경고를 표시 하지 않는 0 @no__t 삽입 하는 메시지를 표시 하지 않습니다.
