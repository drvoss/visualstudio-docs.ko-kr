...
## <a name="in-this-section"></a>섹션 내용
 [방법: 최적화 된 코드](../debugger/how-to-debug-optimized-code.md) 디버그는 최적화 된 코드 디버깅, 특히 프로그램의 최적화 되지 않은 버전을 디버깅 해야 하는 이유, 디버그 및 릴리스 구성에 대 한 기본 최적화 설정, 디버그 및 릴리스 구성에 대 한 팁을 제공 합니다. 최적화 된 코드에 표시 됩니다 (디버그 빌드 구성에서 최적화 설정).
 ...
 [C/C++ 어설션은](../debugger/c-cpp-assertions.md) 어설션 문, 작동 방법, 사용 하는 이점 (논리 오류 catch, 작업 결과 확인, 오류 조건 테스트),와 `_DEBUG`의 상호 작용 및 어설션의 형식을 설명 합니다. 에서 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]지원 됩니다.

 [방법: 디버그 인라인 어셈블리 코드](../debugger/how-to-debug-inline-assembly-code.md) 는 디스어셈블리 창을 사용 하 여 어셈블리 지침 및 레지스터 창을 보는 방법에 대 한 간략 한 지침을 제공 하 여 레지스터 내용을 확인 하 고 해당 창에 대 한 항목의 링크를 제공 합니다.
 ...
 [네이티브 코드 디버그 faq](../debugger/debugging-native-code-faqs.md) 시각적 C++ 프로그램 디버깅에 대해 자주 묻는 질문과 대답을 제공 합니다.
 ...
 [방법: 삽입 된 코드](../debugger/how-to-debug-injected-code.md) 디버그에서는 특성을 사용 하는 디버깅 코드에 대 한 지침을 제공 합니다. 여기에는 소스 주석을 표시하는 방법, 삽입한 코드를 보는 방법, 현재 실행 위치에서 디스어셈블리 코드를 보는 방법 등의 내용이 들어 있습니다.

 [연습: 병렬 응용 프로그램](../debugger/walkthrough-debugging-a-parallel-application.md) 디버깅 병렬 **작업** 및 **병렬 스택** 도구 창을 사용 하 여 병렬 응용 프로그램을 디버깅 하는 방법을 설명 합니다.

## <a name="related-sections"></a>관련 단원
 [Visual C++ 프로젝트 형식](../debugger/debugging-preparation-visual-cpp-project-types.md) 에서는 visual C++ 프로젝트 템플릿에서 만든 네이티브 프로젝트 형식을 디버깅 하는 방법을 설명 하는 항목에 대 한 링크를 제공 합니다.
