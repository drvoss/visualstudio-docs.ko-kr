...
HTML 및 JavaScript를 사용 하 여 UWP 앱을 디버깅 하기 위한 Visual Studio의 바로 가기 키입니다.

## <a name="general-shortcuts"></a>일반 바로 가기

 이러한 바로 가기는 HTML 및 JavaScript를 사용 하는 UWP 앱 용 모든 도구에서 작동 합니다.
...
|**HTML로 편집**을 사용하여 변경 내용 삭제|Esc 키|
