---
title: ', VB |에 C#권장 되는 디버거 속성 설정 Microsoft Docs'
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
...
|**속성 이름**|**설정**|
|-----------------------|-----------------|
|**최적화 사용**|위의 표에 나와 있는 **코드 최적화** 옵션에 지정 된 이유에 대해 false로 설정 합니다.|
