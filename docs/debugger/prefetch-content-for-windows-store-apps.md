...
- [블로그 게시물: Visual Studio 2013 업데이트 2에서 Windows 스토어 앱에 대 한 프리페치 트리거](https://devblogs.microsoft.com/devops/triggering-prefetch-for-windows-store-apps-in-visual-studio-2013-update-2/)