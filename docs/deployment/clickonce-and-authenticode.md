...
- New-selfsignedcertificate PowerShell cmdlet을 사용 하거나 [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)]에 포함 된 *makecert.exe*를 사용 하 여 사용자 고유의 인증서를 생성 합니다.
...
- 인증서를 업데이트하는 명령줄 어셈블리를 만듭니다. 이 프로세스에 대한 단계별 정보는 [Microsoft 지원 문서 925521](https://support.microsoft.com/help/925521)에서 찾을 수 있습니다.
