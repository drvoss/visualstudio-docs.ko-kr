...
[“레코드” 화면](https://docs.microsoft.com/visualstudio/ide/how-to-report-a-problem-with-visual-studio?view=vs-2019#record-a-repro)에서 멈춘 Visual Studio 세션을 선택해야 합니다.

멈춘 Visual Studio 인스턴스가 관리자 모드에서 시작된 경우, 두 번째 인스턴스도 관리자 모드에서 시작되어야 합니다.
