...
|일치 문자열을 [줄의 끝](/dotnet/standard/base-types/anchors-in-regular-expressions#end-of-string-or-line-)에 고정합니다.|\r?$|`end\r?$`는 줄의 끝부분에 나타날 때만 단어 “end”와 일치합니다.|
