...
![코드의 &#45; 코드 맵 맵 관계](../modeling/media/codemapstoryboardpaint.png)
...
## <a name="navigate-and-examine-code-from-the-map"></a>맵에서 코드 탐색 및 검사
 ...
 ![코드 맵은 &#45; 필드 정의를 검사 합니다.](../modeling/media/codemapstoryboardpaint5.png)

 ![코드 맵은 &#45; 필드 정의를 검사 합니다.](../modeling/media/codemapstoryboardpaint5a.png)
...
> Windows Phone 또는 Windows 스토어와 같은 여러 앱에 공유되는 프로젝트에서 항목을 추가할 경우 해당 항목은 항상 현재 활성화된 앱 프로젝트와 함께 맵에 나타납니다. 따라서 컨텍스트를 다른 앱 프로젝트로 변경하는 경우 맵의 컨텍스트도 공유 프로젝트에서 새로 추가된 항목에 대해 변경됩니다. 맵의 항목에 수행하는 작업은 동일한 컨텍스트를 공유하는 항목에만 적용됩니다.
 ...
 ![코드 맵 &#45; 변경 레이아웃](../modeling/media/codemapstoryboardpaint7a.png)

> [!TIP]
> **증분 레이아웃** 은 기본적으로 설정 되어 있습니다. 이 설정은 새 항목을 추가할 때 맵을 가능한 적게 다시 정렬합니다. 새 항목을 추가할 때마다 전체 맵을 다시 정렬 하려면 **증분 레이아웃**을 해제 합니다.

 ![코드 맵 &#45; 변경 레이아웃](../modeling/media/codemapstoryboardpaint7.png)
 ...
 ![코드 맵 &#45; 검사 메서드 정의](../modeling/media/codemapstoryboardpaint8.png)
 ...
 ![코드 맵 &#45; 검사 메서드 정의](../modeling/media/codemapstoryboardpaint9.png)

 이제 `addPaintObject` 메서드 정의를 검사합니다. 또한 `history` 및 `paintObjects`도 사용하여 일부 작업을 수행합니다. `Repaint`도 호출합니다.

 ![코드 맵 &#45; 검사 메서드 정의](../modeling/media/codemapstoryboardpaint10.png)
...
## <a name="find-the-problem-by-examining-the-map"></a>맵을 검토하여 문제 찾기
 ...
 ![코드 맵이 &#45; 누락 된 메서드 호출을 찾습니다.](../modeling/media/codemapstoryboardpaint11.png)
...
## <a name="share-your-discovery-and-next-steps"></a>검색 및 다음 단계 공유
 ...
 ![후속 처리 &#45; 를 위한 코드 맵 주석 및 플래그 항목](../modeling/media/codemapstoryboardpaint12.png)

 예를 들어 맵에 주석을 추가하고 색을 사용하여 항목에 플래그를 지정할 수 있습니다.

 ![코드 맵 &#45; 주석이 지정 되 고 플래그가 지정 된 항목](../modeling/media/codemapstoryboardpaint12a.png)
...
## <a name="fix-the-problem-and-show-what-you-did"></a>문제를 해결하고 수행했던 작업 표시
 ...
 ![코드 맵 &#45; missing 메서드 호출 추가](../modeling/media/codemapstoryboardpaint14.png)
 ...
 ![메서드 호출이 &#45; 없는 코드 맵 업데이트 맵](../modeling/media/codemapstoryboardpaint16.png)

 이제 맵은 **실행 취소** 와 다시 **그리기**간의 링크를 표시 합니다.

 ![메서드 호출 &#45; 을 사용 하 여 맵 업데이트 된 코드 맵](../modeling/media/codemapstoryboardpaint17.png)
