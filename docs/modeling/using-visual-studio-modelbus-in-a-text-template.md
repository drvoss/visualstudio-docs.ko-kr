...
11. DSL이 작동 하는지 확인 합니다. 실험적 프로젝트에서 `Sample.provider`를 엽니다. Visual Studio의 실험적 인스턴스를 닫습니다.
...
1. Visual Studio의 실험적 인스턴스에서 샘플 텍스트 템플릿 파일을 엽니다. 다음과 같이 콘텐츠를 설정 합니다.
    ...
    - @No__t_2 지시어의 `hostSpecific` 및 `inherits` 특성을 설정 해야 합니다.
...
4. Visual Studio의 실험적 인스턴스에서 `Debugging\Sample.consume`를 엽니다.
