...
**Q. RTVS가 Visual Studio Express Edition에서 작동하나요?**

a. 아니요.

**Q. RTVS에서 Visual Studio 확장을 사용할 수 있나요?**

a. 물론입니다! 실제로 R을 사용하는 사용자들이 많이 사용하는 몇 가지 확장은 다음과 같습니다.
...
**Q. RTVS가 Visual Studio에 있기 때문에, C#, C++ 및 다른 Microsoft 언어와 함께 R을 쉽게 사용할 수 있나요?**

a. 아니요. RTVS는 R 코드를 개발하기 위한 도구이며, 표준 네이티브 R 인터프리터를 사용합니다. R과 다른 언어 간의 상호 운용성은 현재 지원되지 않습니다.

**Q. RTVS는 영어가 아닌 로캘에서 작동하나요?**
...
**Q. RTVS가 32비트 버전의 R에서 작동하나요?**

a. 아니요, RTVS는 64비트 버전의 Windows에서 실행되는 64비트 버전의 R만 지원합니다.

**Q. RTVS가 내 소스 제어 시스템에서 작동하나요?**

a. 예, Visual Studio에 통합된 모든 소스 제어 시스템을 사용할 수 있습니다.

**Q. RTVS 프로젝트에 대해 권장되는 *.gitignore* 설정은 무엇인가요?**

a. GitHub에서는 권장되는 *.gitignore* 파일의 마스터 리포지토리를 유지 관리합니다. 이 항목은 다음에서 볼 수 있습니다. [R .gitignore](https://github.com/github/gitignore/blob/master/R.gitignore)

## <a name="remote-services"></a>원격 서비스

Q. **Visual Studio의 원격 서비스가 무엇인가요?**
...
Q. **RTVS에서 Microsoft Machine Learning Server에 연결할 수 있나요?**

a. 아니요, Microsoft ML Server는 다른 기술이며 RTVS에서 요구하는 같은 연결 메커니즘을 제공하지 않습니다.

Q. **RTVS가 Azure의 데이터 과학 VM 이미지를 사용하여 만든 VM에 연결할 수 있나요?**
