...
대체 방법으로 [원격 디버깅](https://go.microsoft.com/fwlink/p/?LinkId=623041)을 사용하여 Azure에서 실행 중인 클라우드 서비스로 직접 연결할 수 있습니다.
...
1. **IntelliTrace 설정** 대화 상자에서 기록할 이벤트, 호출 정보를 수집할지 여부, 로그를 수집할 모듈 및 프로세스, 기록에 할당할 공간의 크기를 지정할 수 있습니다. IntelliTrace에 대한 자세한 내용은 [IntelliTrace로 디버깅](https://go.microsoft.com/fwlink/?LinkId=214468)을 참조하세요.
