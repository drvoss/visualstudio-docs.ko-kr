...
경고 C6250: MEM_RELEASE 플래그를 사용 하지 않고 \<함수 > VirtualFree를 호출 하면 메모리를 확보할 수 있지만 주소 설명자 (VADs)는 사용할 수 없습니다. 주소 공간 누수 결과  
 ...
 자세한 내용은 [VirtualAlloc](https://go.microsoft.com/fwlink/?LinkId=181201) 및 [VirtualFree](https://go.microsoft.com/fwlink/?LinkId=181202)를 참조 하세요.  
