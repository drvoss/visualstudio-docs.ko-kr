...
## <a name="example"></a>예제
 다음 예제에서는 적절 한 <xref:System.Runtime.InteropServices.MarshalAsAttribute> 특성으로 표시 된 두 개의 플랫폼 호출 메서드를 보여 줍니다.
...
## <a name="see-also"></a>관련 항목:
 [부울 형식에 대 한 기본 마샬링](https://msdn.microsoft.com/d4c00537-70f7-4ca6-8197-bfc1ec037ff9) <xref:System.Runtime.InteropServices.UnmanagedType?displayProperty=fullName> [비관리 코드와의 상호 운용](https://msdn.microsoft.com/library/ccb68ce7-b0e9-4ffb-839d-03b1cd2c1258)
