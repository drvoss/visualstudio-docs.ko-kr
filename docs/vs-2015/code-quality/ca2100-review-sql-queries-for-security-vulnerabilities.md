...
- 명령 문자열을 빌드하기 전에 형식 및 내용에 대 한 사용자 입력의 유효성을 검사 합니다.
  ...
  다음 [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] 형식은 <xref:System.Data.IDbCommand.CommandText%2A> 속성을 구현 하거나 문자열 인수를 사용 하 여 속성을 설정 하는 생성자를 제공 합니다.
