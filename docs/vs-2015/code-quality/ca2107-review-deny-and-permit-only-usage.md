...
## <a name="rule-description"></a>규칙 설명
 PermitOnly 메서드 및 <xref:System.Security.CodeAccessPermission.Deny%2A?displayProperty=fullName> 보안 작업을 [사용 하](https://msdn.microsoft.com/8c7bdb7f-882f-45b7-908c-6cbaa1767649) 는 것은 [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] 보안에 대 한 고급 지식이 있는 사용자만 사용 해야 합니다. 이러한 보안 동작을 사용하는 코드는 보안 검토를 거쳐야 합니다.
...
**linkdemand: 호출자의 deny는 어설션된 권한이 있는 linkdemand에는 영향** 을 주지 않습니다. 
**linkdemand: 호출자의 deny는 linkdemand로 보호 된 코드에 영향을** 주지 않습니다. 
**linkdemand:이 Deny는에 영향을 주지 않습니다. LinkDemand로 보호 된 코드.**
