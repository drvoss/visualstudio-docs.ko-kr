...
## <a name="rule-description"></a>규칙 설명
 ...
 @No__t_0 2.0에는 *투명도*라는 기능이 도입 되었습니다. 개별 메서드, 필드, 인터페이스, 클래스 및 형식은 투명 하거나 중요할 수 있습니다.
...
## <a name="how-to-fix-violations"></a>위반 문제를 해결하는 방법
 이 문제를 해결 하려면 <xref:System.Security.SecurityCriticalAttribute>를 사용 하 여 어설션을 호출 하는 코드를 표시 하거나 어설션을 제거 합니다.
...
## <a name="example"></a>예제
 한 가지 옵션은 아래 예제에서 SecurityTransparentMethod 메서드를 코딩 하는 코드를 검토 하는 것이 고, 메서드가 권한 상승을 위해 안전한 것으로 간주 되는 경우 SecurityTransparentMethod를 보안 위험으로 표시 하는 것이 필요 합니다. 감사는 Assert의 메서드 내에서 발생 하는 모든 호출을 통해 메서드에서 수행 되어야 합니다.
