...
|**시각적 C++ 응용 프로그램 배포:** 중앙 배포, 로컬 배포 C++ 또는 정적 연결을 사용 하 여 응용 프로그램과 함께 visual runtime을 배포할 수 있습니다.|[네이티브 데스크톱 애플리케이션 배포(Visual C++)](/cpp/windows/deploying-native-desktop-applications-visual-cpp)|  
...
|**설치 필수 구성 요소:** 부트스트래퍼 라고 하는 일반 설치 관리자를 구성 하 여 데스크톱 응용 프로그램에 대 한 필수 구성 요소를 설치할 수 있습니다.|[애플리케이션 배포 필수 조건](../deployment/application-deployment-prerequisites.md)|
