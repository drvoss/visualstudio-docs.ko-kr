...
|.NET을 처음 사용하세요?|[.NET Framework의 개요](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [애플리케이션 주요 사항](https://msdn.microsoft.com/library/653da4ba-3752-4d1f-a08a-de017dc86ecc)<br /><br /> [Visual C# 및 Visual Basic 시작](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|
