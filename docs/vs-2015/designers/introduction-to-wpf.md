...
WPF(Windows Presentation Foundation)를 사용하면 시각적으로 뛰어난 사용자 환경을 통해 Windows용 데스크톱 클라이언트 애플리케이션을 만들 수 있습니다.
 ...
 ![Contoso 의료 UI 샘플](../designers/media/wpfintrofigure24.png "WPFIntroFigure24")
...
```
 ...
 ![단추를 포함 하는 창입니다.](../designers/media/wpfintrofigure10.png "WPFIntroFigure10")
...
### <a name="2-d-shapes"></a>2차원 도형
 ...
 ![타원과 사각형](../designers/media/wpfintrofigure4.PNG "WPFIntroFigure4")
 ...
 !["사용자가 타원&#33;을 클릭 했습니다." 라는 텍스트가 있는 창](../designers/media/wpfintrofigure12.png "WPFIntroFigure12")
...
### <a name="2-d-effects"></a>2차원 효과
 ...
 ![여러 브러시의 그림](../designers/media/wpfintrofigure6.PNG "WPFIntroFigure6")
...
## <a name="Animation"></a> 애니메이션
 ...
 ![애니메이션 효과 큐브의 이미지](../designers/media/wpfintrofigure7.png "WPFIntroFigure7")
...
### <a name="video-and-audio"></a>비디오 및 오디오
 ...
 ![오디오 및 비디오를 사용 하는 MediaElement 컨트롤](../designers/media/wpfintrofigure1.png "WPFIntroFigure1")
...
- 국가별 글꼴 지원 및 대체(fallback) 메커니즘
  ...
  ![다양 한 텍스트 장식이 있는 텍스트](../designers/media/wpfintrofigure23.png "WPFIntroFigure23")
...
[!code-xml[IntroToWPFSnippets#TextBoxContentMARKUP3](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/TextBoxContentWindow.xaml#textboxcontentmarkup3)]
 ...
 ![텍스트를 포함 하는 TextBox 컨트롤](../designers/media/wpfintrofigure21.png "WPFIntroFigure21")
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/ButtonContentWindow.xaml#buttoncontentmarkup3)]
 ...
 ![여러 유형의 콘텐츠를 포함 하는 단추](../designers/media/wpfintrofigure22.png "WPFIntroFigure22")
...
### <a name="data-templates"></a>데이터 템플릿
 ...
 ![기본 모양이 있는 목록 상자](../designers/media/wpfintrofigure18.png "WPFIntroFigure18")
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/DataTemplateWindow.xaml#datatemplatemarkup4)]
 ...
 ![데이터 템플릿을 사용 하는 목록 상자](../designers/media/wpfintrofigure19.png "WPFIntroFigure19")
...
## <a name="see-also"></a>관련 항목:
 [WPF 시작](../designers/getting-started-with-wpf.md) [Windows Presentation Foundation을 사용하여 최신 데스크톱 응용 프로그램 만들기](../designers/create-modern-desktop-applications-with-windows-presentation-foundation.md) [Windows Presentation Foundation](https://msdn.microsoft.com/library/ms754130\(v=vs.100\).aspx)
