...
|Property (HTML Representation)|설명|
|--------------------------------------|-----------------|
...
|-|-|
|기능:|**CollapsibleArea**|
|사용:|Expand collapses content control text|
|**요소**|**Value**|
|ExpandText|Expand|
|CollapseText|축소|
|기능:|**CodeSnippet**|
|사용:|Code snippet control text.  Note: Code snippet content with “Non-Breaking” space will be changed to space.|
|**요소**|**Value**|
...
|VBDeclaration|선언|
|VBUsage|사용 현황|
|기능:|**Feedback, Footer, and Logo**|
|사용:|Provide a Feedback control for customer to supply feedback on the current topic via e-mail.  Copyright text for the content.  Logo definition.|
|**요소**|**Value  (These strings can be modified to meet content adopter need.)**|
...
|기능:|**Disclaimer**|
|사용:|A set of case specific disclaimers for machine translated content.|
|**요소**|**Value**|
...
|기능:|**LinkTable**|
|사용:|Support for online topic links|
|**요소**|**Value**|
...
|OnlineText|Online|
|기능:|**Video Audio control**|
|사용:|Display elements and text for video content|
|**요소**|**Value**|
...
|기능:|**Content Not Installed control**|
|사용:|Text elements (strings) used for the rendering of contentnotinstalled.htm|
|**요소**|**Value**|
...
|기능:|**Topic Not Found control**|
|사용:|Text elements (strings) used for the rendering of topicnotfound.htm|
|**요소**|**Value**|
...
|기능:|**Topic Corrupted Control**|
|사용:|Text elements (strings) used for the rendering of topiccorrupted.htm|
|**요소**|**Value**|
...
|기능:|**Home Page control**|
|사용:|Text supporting the display of the Help Viewer top level node content.|
|**요소**|**Value**|
...
||||
|-|-|-|
|**Branding Feature**|**JavaScript Function**|**설명**|
...
||||
|-|-|-|
|**파일**|**Use**|**Displayed Content Source**|
...
|info_icon.gif|Used when displaying information|고지 사항|
...
7. 솔루션을 빌드합니다. This creates a set of files in a release folder, which will be used in the next section.
