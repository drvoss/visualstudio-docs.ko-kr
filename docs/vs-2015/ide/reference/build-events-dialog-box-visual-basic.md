...
## <a name="see-also"></a>관련 항목:
 [컴파일 페이지, 프로젝트 디자이너 (Visual Basic)](../../ide/reference/compile-page-project-designer-visual-basic.md) [How: 빌드 [전 이벤트/빌드 후 이벤트 명령줄 대화 상자](../../ide/reference/pre-build-event-post-build-event-command-line-dialog-box.md) ](../../ide/how-to-specify-build-events-visual-basic.md) 빌드 이벤트 (Visual Basic) 지정
