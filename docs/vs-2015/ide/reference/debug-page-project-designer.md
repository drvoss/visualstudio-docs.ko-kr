...
## <a name="see-also"></a>관련 항목:
 [Visual Studio의 디버깅](../../debugger/debugging-in-visual-studio.md) [프로젝트 설정 디버그 C# 구성에](../../debugger/project-settings-for-csharp-debug-configurations.md) 대 한 [프로젝트 설정 Visual Basic 디버그 구성에 대 한 프로젝트 설정](../../debugger/project-settings-for-a-visual-basic-debug-configuration.md) [디버깅 속성 관리](https://msdn.microsoft.com/92474d16-e7fe-4fac-9287-6bd6b3a7eb68) [방법: ClickOnce 응용 프로그램 디버그 제한 된 권한](../../deployment/how-to-debug-a-clickonce-application-with-restricted-permissions.md) [방법: 구성 만들기 및 편집](../../ide/how-to-create-and-edit-configurations.md)
