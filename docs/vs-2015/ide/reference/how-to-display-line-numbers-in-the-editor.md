...
2. ![편집기에 줄 번호를 표시하는 옵션](../../ide/reference/media/vs-displaylinenumbers.png "|::ref1::|")

> [!NOTE]
> 언어나 설정에 따라 **옵션** 대화 상자에서 **모든 설정 표시** 확인란을 선택하여 **모든 언어** 하위 노드를 표시해야 할 수 있습니다.

## <a name="see-also"></a>참고 항목
 [편집기 ](../../ide/customizing-the-editor.md) [Text 편집기 옵션 대화 상자 사용자 지정 [Writing 코드 ](../../ide/reference/text-editor-options-dialog-box.md)](../../ide/writing-code-in-the-code-and-text-editor.md)
