...
## <a name="see-also"></a>참고 항목
 [Devenv 명령줄 스위치](../../ide/reference/devenv-command-line-switches.md) [/Build (devenv.exe](../../ide/reference/build-devenv-exe.md) ) [/Clean (](../../ide/reference/clean-devenv-exe.md) devenv.exe) [/out (devenv.exe)](../../ide/reference/out-devenv-exe.md)
