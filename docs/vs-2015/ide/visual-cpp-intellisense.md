...
- Android 프로젝트에 대해 `__ANDROID__`이 정의 되어 있으므로 8 줄의 #else 분기가 비활성 영역을 나타내기 위해 회색으로 표시 됩니다.
...
- 줄 12에는 BYE 식별자에 빨간색 물결 기호가 있습니다. 이 식별자는 현재 선택한 활성 프로젝트에 정의되어 있지 않습니다.
  ...
  ![iOS가 활성 프로젝트로 선택 됩니다.](../ide/media/intellisensecppcrossplatform2.png "IntelliSenseCppCrossPlatform2")
...
## <a name="single-file-intellisense"></a>단일 파일 IntelliSense
 ...
 ![헤더 파일에 대 한 경로 추가](../ide/media/intellisensedebugyourcode.jpg "IntelliSenseDebugYourCode")
