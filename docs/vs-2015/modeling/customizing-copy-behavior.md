...
- 복사한 요소 간의 관계 링크
  ...
  ![복사 및 붙여넣은 요소](../modeling/media/dslcopypastedefault.png "DslCopyPasteDefault")
...
사용자가 여러 모양을 복사할 때 모양이 붙여넣기되는 상대 위치를 보존할 수 있습니다. 이 기법은 [VMSDK 예제에서 보여 줍니다. 회로 다이어그램 샘플 ](http://go.microsoft.com/fwlink/?LinkId=213879)입니다.
...
## <a name="customizeLinks"></a>링크 복사 동작 사용자 지정
 ...
 ![도메인 역할의 복사 속성을 전파 합니다.](../modeling/media/dslpropagatescopy.png "DslPropagatesCopy")
...
- Propagate copy to link and opposite role player - 복사한 그룹에 링크 반대쪽의 요소 복사본이 포함됩니다.
  ...
  ![PropagateCopyToLinkOnly를 사용한 복사 효과](../modeling/media/dslpropagatecopy.png "DslPropagateCopy")
...
## <a name="receiving-items-dragged-from-other-models"></a>다른 모델에서 끈 항목 수신
 ElementOperations를 사용하여 복사, 이동, 삭제 및 끌어서 놓기 동작을 정의할 수도 있습니다. ElementOperations 사용법을 설명하기 위해 여기서 제공하는 예제에서는 사용자 지정 끌어서 놓기 동작을 정의합니다. 그러나이를 위해 [How에 설명 된 대체 방법을 고려할 수 있습니다. 보다 확장 가능한 끌어서 놓기 처리기 ](../modeling/how-to-add-a-drag-and-drop-handler.md)를 추가 합니다.
...
## <a name="standard-copy-behavior"></a>표준 복사 동작
 ...
 사용자가 Ctrl+C를 누르거나 복사 메뉴 명령을 사용하면 <xref:Microsoft.VisualStudio.Modeling.Shell.ClipboardCommandSet.ProcessOnMenuCopyCommand%2A> 메서드가 호출됩니다. **Dslpackage\generated Code\CommandSet.cs**에서이 설정이 어떻게 설정 되었는지 확인할 수 있습니다. 명령을 설정 하는 방법에 대 한 자세한 내용은 다음에 대 한 [How를 참조 하세요. @No__t_0 바로 가기 메뉴에 명령을 추가 합니다.
...
## <a name="see-also"></a>관련 항목:
 [요소 만들기 및 이동 [How 사용자 지정](../modeling/customizing-element-creation-and-movement.md) : @No__t_2Sample [삭제 동작을 사용자 지정](../modeling/customizing-deletion-behavior.md) 하 ](../modeling/how-to-add-a-drag-and-drop-handler.md) 끌어서 놓기 처리기를 추가 합니다. VMSDK 회로 다이어그램 샘플 ](http://go.microsoft.com/fwlink/?LinkId=213879)
