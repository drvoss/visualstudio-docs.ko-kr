...
1. **F5**키를 누르거나, **디버그** 메뉴에서 **디버깅 시작**을 선택합니다.
     ...
     **문제 해결**: 새 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]이 시작 되지 않으면 다음을 수행 합니다.
...
## <a name="see-also"></a>관련 항목:
 [모델링 확장 정의 및 설치](../modeling/define-and-install-a-modeling-extension.md) [uml 모델 및 다이어그램 확장](../modeling/extend-uml-models-and-diagrams.md) [모델링 다이어그램에서 제스처 처리기 정의](../modeling/define-a-gesture-handler-on-a-modeling-diagram.md) [사용자 지정 모델링 도구 상자 항목 정의](../modeling/define-a-custom-modeling-toolbox-item.md) [UML 모델에 대 한 유효성 검사 제약 조건 정의](../modeling/define-validation-constraints-for-uml-models.md) [편집 ](../modeling/edit-uml-sequence-diagrams-by-using-the-uml-api.md)Uml api 프로그래밍을 사용 하는 uml 시퀀스 다이어그램 [Sample UML api를 사용 [합니다](../modeling/programming-with-the-uml-api.md) . UML 다이어그램에서 셰이프를 정렬 하는 명령 ](http://go.microsoft.com/fwlink/?LinkID=213809)
