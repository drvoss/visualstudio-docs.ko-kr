...
ms.locfileid: "72669873"
---
# <a name="defining-a-locking-policy-to-create-read-only-segments"></a>잠금 정책을 정의하여 읽기 전용 세그먼트 만들기
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

@No__t_0 시각화 및 모델링 SDK의 불변성 API를 사용 하면 프로그램에서 DSL (도메인 특정 언어) 모델의 일부 또는 전부를 잠그고 변경할 수 있습니다. 예를 들어이 읽기 전용 옵션을 사용 하면 사용자가 동료에 게 DSL 모델에 주석을 달고 검토할 수 있지만 원래는 변경 하지 못하게 할 수 있습니다.
...
> 리플렉션을 사용 하 여 잠금 정책을 우회할 수 있습니다. 타사 개발자를 위한 명확한 경계를 제공 하지만 강력한 보안을 제공 하지는 않습니다.
 ...
 추가 정보 및 샘플은 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [시각화 및 모델링 SDK](http://go.microsoft.com/fwlink/?LinkId=186128) 웹 사이트에서 사용할 수 있습니다.
