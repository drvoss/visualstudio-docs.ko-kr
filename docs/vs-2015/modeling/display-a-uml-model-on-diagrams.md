...
|동작|상호 작용(시퀀스),<br /><br /> 활동|해당 다이어그램에 동작을 바인딩합니다.<br /><br /> 한 번에 최대 하나의 다이어그램에 각 동작을 바인딩할 수 있습니다.<br /><br /> 예를 들면,<br /><br /> `sequenceDiagram.Bind(interaction);`<br /><br /> `activityDiagram.Bind(activity);`|
...
## <a name="see-also"></a>관련 항목:
 [Uml 모델 및 다이어그램 확장](../modeling/extend-uml-models-and-diagrams.md) [uml 모델](../modeling/navigate-the-uml-model.md) [샘플: 다이어그램에서 셰이프 맞춤 메뉴 명령](http://go.microsoft.com/fwlink/?LinkId=213809) [샘플: 요소, 모양 및 스테레오 타입 만들기](http://go.microsoft.com/fwlink/?LinkId=213811)
