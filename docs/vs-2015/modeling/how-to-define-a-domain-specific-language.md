...
## <a name="trouble"></a>슈팅이
 아래 테이블에는 DSL을 디자인할 때 가장 흔히 발생하는 몇 가지 문제와 제안 해결 방법이 나와 있습니다. [시각화 도구 문제 포럼](http://go.microsoft.com/fwlink/?LinkId=186074)에서 추가 조언을 사용할 수 있습니다.
