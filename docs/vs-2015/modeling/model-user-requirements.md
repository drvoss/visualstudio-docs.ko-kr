...
## <a name="BusinessRules"></a> Showing Business Rules
 ...
 대부분의 비즈니스 규칙은 개념적 클래스 간의 관계에 대한 제약 조건입니다. 이러한 *정적 비즈니스 규칙* 을 개념적 클래스 다이어그램의 관련 클래스와 연결 된 주석으로 작성할 수 있습니다. 예를 들면,
...
## <a name="Workflow"></a>사용자와 시스템 간의 작업 흐름 표시
 ...
 사용 사례 다이어그램 및 동작 다이어그램을 그려 동일한 정보의 서로 다른 뷰를 표시할 수 있습니다.  사용 사례 다이어그램은 큰 동작 내의 작은 동작 중첩을 표시하는 데 더 효과적이지만 작업 흐름을 표시하지 않습니다. 예를 들면,
...
## <a name="see-also"></a>관련 항목:
 [Uml 모델 및 다이어그램 편집](../modeling/edit-uml-models-and-diagrams.md) [모델에서 테스트 개발](../modeling/develop-tests-from-a-model.md) [개발 프로세스의 모델 사용](../modeling/use-models-in-your-development-process.md) [응용 프로그램 아키텍처](../modeling/model-your-app-s-architecture.md) [샘플 Vs 확장: UML 도메인 모델링 기능](http://go.microsoft.com/fwlink/?LinkId=213849) [샘플 vs 확장: 색 uml 스테레오 타입 별 요소](http://go.microsoft.com/fwlink/?LinkID=213841) [샘플 vs 확장: uml 요소를 다이어그램, 파일 및 기타 요소에 연결](http://go.microsoft.com/fwlink/?LinkID=213813) [샘플 Vs 확장: Uml 다이어그램에서 셰이프 맞춤](http://go.microsoft.com/fwlink/?LinkID=213809) [비디오: 비즈니스 도메인 모델링](http://channel9.msdn.com/posts/clinted/UML-with-VS-2010-Part-3-Modeling-the-Business-Domain/)
