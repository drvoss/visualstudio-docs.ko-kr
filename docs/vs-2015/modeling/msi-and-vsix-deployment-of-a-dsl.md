...
## <a name="msi"></a>MSI에 DSL 배포
 ...
 MSI를 빌드하려면 설치 프로젝트를 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 솔루션에 추가 합니다. 설치 프로젝트를 만드는 가장 쉬운 방법은 [VMSDK 사이트](http://go.microsoft.com/fwlink/?LinkID=186128)에서 다운로드할 수 있는 CreateMsiSetupProject.tt 템플릿을 사용 하는 것입니다.
