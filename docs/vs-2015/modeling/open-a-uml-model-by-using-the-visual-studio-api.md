...
- 프로젝트가 모델링 프로젝트이 고 프로젝트가 현재 AppDomain에 로드 된 경우에는 `EnvDTE.Project`를 `IModelingProject`와 캐스팅할 수 있습니다.

- 항목이 UML 다이어그램 인 경우 `EnvDTE.ProjectItem`를 `IDiagramContext`와 캐스팅할 수 있습니다.
