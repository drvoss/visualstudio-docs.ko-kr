...
## <a name="the-standard-profiles"></a>표준 프로필
 다음 프로필은 설치 하는 즉시 지원 되는 Visual Studio 버전에서 사용할 수 있습니다.
...
|[C#Profile](#NetProfile)|UML 모델의 클래스 또는 기타 요소로 프로그램 코드를 나타내려는 경우 C# 프로필에서 스테레오타입 중 하나를 적용하여 이를 나타낼 수 있습니다.<br /><br /> 또한 이러한 스테레오타입은 모델 요소에 속성을 추가합니다.|
...
|스테레오타입|적용 대상|의미|
|----------------|----------------|-------------|
|auxiliary|인스턴스|일반적으로 추가 논리를 구현하여 다른 클래스를 지원하는 클래스입니다. 다른 클래스에 «focus» 스테레오타입이 있을 수 있습니다.|
...
|형식(type)|인스턴스|구현 방법을 지정하지 않고 개체의 동작을 지정합니다. 개체는 사양을 준수하는 경우 형식의 멤버입니다.|
|utility|인스턴스|정적 함수의 컬렉션입니다. 클래스에 인스턴스가 없습니다.|
...
|스테레오타입|적용 대상|데이터 액세스|
|----------------|----------------|----------------|
|**C#클래스**|UML 클래스<br /><br /> 구성 요소|**Clr 특성**<br /><br /> **부분**<br /><br /> **봉인 됨**<br /><br /> **Static**<br /><br /> **안전 하지 않음**<br /><br /> **패키지 표시 유형**|
|**C#구조체**|UML 클래스<br /><br /> 구성 요소|**Clr 특성**<br /><br /> **부분**<br /><br /> **안전 하지 않음**<br /><br /> **패키지 표시 유형**|
|**C#전역 멤버**|UML 클래스<br /><br /> 구성 요소|**Clr 특성**|
|**C#감열재**|UML 인터페이스|**Clr 특성**<br /><br /> **부분**<br /><br /> **패키지 표시 유형**|
|**C#열거형**|UML 열거형|**ClrAttributes**<br /><br /> **기본 형식**|
|**C#공간**|UML 패키지|**Clr 특성**<br /><br /> **기본 이름**<br /><br /> **네임스페이스 사용**|
