...
ms.locfileid: "72659290"
---
# <a name="walkthrough-connecting-a-host-to-a-generated-directive-processor"></a>연습: 생성된 지시문 프로세서에 호스트 연결
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

텍스트 템플릿을 처리 하는 고유한 호스트를 작성할 수 있습니다. 기본 사용자 지정 호스트는 [Walkthrough에서 보여 줍니다. @No__t_0 사용자 지정 텍스트 템플릿 호스트 만들기 여러 출력 파일을 생성 하는 등의 기능을 추가 하 여 해당 호스트를 확장할 수 있습니다.
...
> [!WARNING]
> 이 연습은 [Walkthrough을 기반으로 합니다. @No__t_0 사용자 지정 텍스트 템플릿 호스트 만들기 먼저이 연습을 수행 합니다.
...
|Visual Studio Visualization and Modeling SDK|[http://go.microsoft.com/fwlink/?LinkID=186128](http://go.microsoft.com/fwlink/?LinkID=186128)|
 ...
 또한 [Walkthrough에서 만든 사용자 지정 텍스트 템플릿 변환이 있어야 합니다. @No__t_0 사용자 지정 텍스트 템플릿 호스트 만들기
...
## <a name="connecting-a-custom-text-template-host-to-a-directive-processor"></a>사용자 지정 텍스트 템플릿 호스트를 지시문 프로세서에 연결
 지시문 프로세서를 생성 한 후 [Walkthrough에서 만든 지시문 프로세서와 사용자 지정 텍스트 템플릿 호스트를 연결 합니다. @No__t_0 사용자 지정 텍스트 템플릿 호스트 만들기
