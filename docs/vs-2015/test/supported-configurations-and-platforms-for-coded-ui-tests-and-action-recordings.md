...
|.NET|.NET 2.0, 3.0, 3.5, 4 및 4.5. **참고:** [!INCLUDE[TCMext](../includes/tcmext-md.md)] 및 Visual Studio는 둘 다 .net 4가 필요 합니다. 그러나 여기 나열된 .NET 버전을 사용하여 개발한 애플리케이션은 모두 지원됩니다.|
