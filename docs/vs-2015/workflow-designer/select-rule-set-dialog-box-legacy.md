...
ms.locfileid: "72663324"
---
# <a name="select-rule-set-dialog-box-legacy"></a>규칙 집합 선택 대화 상자(레거시)
이 항목에서는 기존 [!INCLUDE[wfd1](../includes/wfd1-md.md)]에서 **규칙 집합 선택** 대화 상자를 사용 하는 방법에 대해 설명 합니다. 레거시 [!INCLUDE[wfd2](../includes/wfd2-md.md)]는 [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] 또는 [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]를 대상으로 해야 하는 경우에 사용합니다.

 **규칙 집합 선택** 대화 상자는 [policyactivity](http://go.microsoft.com/fwlink?LinkID=65019) 활동에 사용할 수 있는 규칙 집합을 선택 하는 데 사용 됩니다. **규칙 집합 선택** 대화 상자에 액세스 하는 방법에 대 한 자세한 내용은 [방법: Policyactivity 규칙 집합 만들기 (레거시)](../workflow-designer/how-to-create-a-policyactivity-rule-set-legacy.md)를 참조 하세요.
...
|**그래**|선택한 규칙 집합을 **Policyactivity** 활동에 할당 하려면 클릭 합니다.|
...
## <a name="see-also"></a>관련 항목:
 [Policyactivity](http://go.microsoft.com/fwlink?LinkID=65019) [규칙 집합 편집기 대화 상자 (레거시)](../workflow-designer/rule-set-editor-dialog-box-legacy.md) [워크플로에서 조건을 사용 하 여](http://go.microsoft.com/fwlink?LinkID=65009) [policyactivity 활동 사용](http://go.microsoft.com/fwlink?LinkID=65004)