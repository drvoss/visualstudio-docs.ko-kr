 ...
 **규칙 집합 선택** 대화 상자는 [policyactivity](https://go.microsoft.com/fwlink?LinkID=65019) 활동에 사용할 수 있는 규칙 집합을 선택 하는 데 사용 됩니다. **규칙 집합 선택** 대화 상자에 액세스 하는 방법에 대 한 자세한 내용은 [방법: Policyactivity 규칙 집합 만들기 (레거시)](../workflow-designer/how-to-create-a-policyactivity-rule-set-legacy.md)를 참조 하세요.
...
## <a name="see-also"></a>참고 항목
 [Policyactivity](https://go.microsoft.com/fwlink?LinkID=65019) [규칙 집합 편집기 대화 상자 (레거시)](../workflow-designer/rule-set-editor-dialog-box-legacy.md) [워크플로에서 조건을 사용 하 여](https://go.microsoft.com/fwlink?LinkID=65009) [policyactivity 활동 사용](https://go.microsoft.com/fwlink?LinkID=65004)