...
## <a name="using-the-sequence-activity-designer"></a>Sequence 활동 디자이너 사용
 @No__t_0 활동을 추가 하려면 **도구 상자** 에서 **Sequence** activity designer를 끌어 [!INCLUDE[wfd1](../includes/wfd1-md.md)] 화면에 놓습니다. 이 <xref:System.Activities.Statements.Sequence> 활동에 자식 활동을 추가 하려면 **도구 상자** 의 다른 활동을 "여기에 작업 놓기" 힌트 텍스트가 있는 상자의 삼각형 위에 놓습니다.
