...
> 워크플로 활동이 없는 어셈블리를 추가하려고 하면 해당 어셈블리에 활동이 없음을 알리는 오류 대화 상자가 표시됩니다.
 ...
 이 대화 상자에서 **도구 상자의 도구** 상자에 표시 하지 않을 항목을 선택 취소 하거나, **도구 상자** 에서 상황에 맞는 메뉴 **옵션을 사용** 하 고 어셈블리를 참조 취소할 수 있습니다. 그러면에서 해당 **항목이 제거 되지 않습니다. 도구 상자**.
