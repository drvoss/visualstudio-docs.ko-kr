...
## <a name="trusted-locations"></a>신뢰할 수 있는 위치
 [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)]와 Office 2010의 응용 프로그램에는 사용자가 신뢰할 수 있는 위치와 같은 보안 및 개인 정보 설정을 구성할 수 있는 신뢰 센터가 있습니다. Office 솔루션의 경우 로컬 컴퓨터는 신뢰할 수 있는 위치로 간주 됩니다. 그러나 더 큰 위험으로 인해 시스템, 각 사용자 및 Internet Explorer에 대한 임시 폴더와 같이 신뢰할 수 없는 특정 디렉터리가 있습니다.
