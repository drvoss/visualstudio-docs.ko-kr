...
1. **리본 XML** 항목을 문서 수준 또는 VSTO 추가 기능 프로젝트에 추가합니다. 자세한 내용은 [방법: 리본 메뉴 사용자 지정 시작](../vsto/how-to-get-started-customizing-the-ribbon.md)을 참조 하세요. 입력
...
9. 처리 하려는 각 컨트롤에 대 한 `Ribbon1` 클래스에 콜백 메서드를 추가 합니다.
