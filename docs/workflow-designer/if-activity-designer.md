...
|속성 이름|필요한 공간|사용 현황|
|-|--------------|-|
|<xref:System.Activities.Statements.If.Condition%2A>|True|실행할 자식 활동을 결정 하는 조건입니다. @No__t_0 설정 하려면 **If** 활동 디자이너의 **조건** 상자 또는 속성 표에 Visual Basic 식을 입력 합니다.|
