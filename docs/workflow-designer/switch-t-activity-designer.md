...
ms.locfileid: "72649892"
---
# <a name="switcht-activity-designer"></a>@No__t_0T > Activity Designer 전환
...
**도구 상자**의 **제어 흐름** 범주에서 > activity designer **\<T 스위치** 에 액세스 합니다. 사용자가 <xref:System.Activities.Statements.Switch%601> 활동에 사용 된 제네릭 형식 *T* 를 지정할 수 있도록 하는 **형식 선택** 대화 상자를 워크플로 디자이너로 끌어 놓습니다. 기본값은 **Int32**입니다. 제네릭 형식 *t* 를 선택 하면 **Switch < T \>** 디자이너가 workflow designer에 추가 됩니다.
