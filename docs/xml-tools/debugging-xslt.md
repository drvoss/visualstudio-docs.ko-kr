...
응용 프로그램을 디버깅 하는 동안 XSLT를 한 단계씩 실행 할 수 있습니다. <xref:System.Xml.Xsl.XslCompiledTransform.Transform%2A?displayProperty=fullName> 호출에서 **F11** 키를 누르면 디버거가 XSLT 코드를 한 단계씩 코드 실행 할 수 있습니다.
